"""
Django settings for MentHAproject project.
...
SECRET_KEY = 'django-insecure-&jfct!(mr#*b1s2z#w9x%%s7e^$6f5)yk)o!+!8xm9vrvhf851'
...
ROOT_URLCONF = 'MentHAproject.urls'
...
WSGI_APPLICATION = 'MentHAproject.wsgi.application'
